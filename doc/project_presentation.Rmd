...
- If test size is increased to 50 %, the model misclassifies 4 snakes as illustrated below:

```{r out.width = "50%"}
include_graphics("../results/05_accuracy_plot_incomplete_training.png")
